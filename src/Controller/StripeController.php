...
class StripeController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager, $reference)
    {
        ...
        foreach ($order->getOrderDetails()->getValues() as $product){
          $product_object =  $this->orderRepository->findOneByName($product->getProduct());
            $product_for_stripe[] = [
                'price_data' => [
               'currency' => 'eur',
...
dd($product_for_stripe);
        ...
        Stripe::setApiKey('sk_test_51IFzX1LidspSVr1ROWWc9Yeh31vrMAB9j6CnTIsI2Z77ICEbuWyqb1NbsiNWIGJzGyzBEfDJnMQfkS5G4kZzZaqq00sZxpzhd2');
